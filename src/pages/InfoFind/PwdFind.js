    ...
    return(
        <Wrap>
            ...
            <div className="find__input__wrap">
                ...
                <FormInput title="아이디(이메일)" placeholder="metapet@gmail.com">전화번호</FormInput>
            </div>

            <p className="phrases__wrap">
            메타펫의 회원 비밀번호는 암호화 저장되어 분실 시 찾아드릴 수 없는 정보입니다.<br/>
            등록된 회원정보 확인을 통해 비밀번호를 재설정 하실 수 있습니다.
            </p>

            <LoginBtn className="idfind__step1__btn">비밀번호 찾기</LoginBtn>
        </Wrap>
    );
}
